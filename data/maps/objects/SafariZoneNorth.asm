SafariZoneNorth_Object:
	...
	def_bg_events
	bg_event 36,  4, 2 ; SafariZoneNorthText3
	bg_event  4, 25, 3 ; SafariZoneNorthText4
	bg_event 13, 31, 4 ; SafariZoneNorthText5
	bg_event 19, 33, 5 ; SafariZoneNorthText6
	bg_event 26, 28, 6 ; SafariZoneNorthText7
