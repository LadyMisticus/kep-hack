...
;	move FEATHERDANCE,	ATTACK_DOWN2_EFFECT,		 0, BIRD, 		100, 15
...
;	move PUNCH, 		NO_ADDITIONAL_EFFECT, 		20, FIGHTING, 	100, 30
;	move KICK, 			NO_ADDITIONAL_EFFECT, 		20, FIGHTING, 	100, 30
	move LUNGE,			ATTACK_DOWN_SIDE_EFFECT,	80, BUG, 		100, 15
	move CHATTER,		CONFUSION_SIDE_EFFECT,		50, BIRD, 		100, 15
	move REPRIMAND,		EVASION_DOWN2_EFFECT,		 0, NORMAL, 	90, 15
	move GASTROJUICE,	ACCURACY_DOWN_SIDE_EFFECT,	75, POISON, 	100, 15
	move NEUROTOXIN,	SPECIAL_DOWN_SIDE_EFFECT,	75, POISON, 	100, 15
	move SLUDGE_SPRAY,	SPEED_DOWN_SIDE_EFFECT,		75, POISON, 	100, 15
	move SLUDGE_BOMB,	POISON_SIDE_EFFECT1,		80, POISON, 	100, 15
	move RAPID_JAB,		TWO_TO_FIVE_ATTACKS_EFFECT, 25, FIGHTING, 	100, 15
	move POLLINATE,		EVASION_DOWN2_EFFECT,		 0, GRASS, 		100, 30
	move VINE_SLAM,		NO_ADDITIONAL_EFFECT,		80, GRASS, 		100, 15
...
;	move FIRE_WALL,		LIGHT_SCREEN_EFFECT,		 0, FIRE,		100, 15
;	move AQUA_WALL,		REFLECT_EFFECT,				 0, WATER,		100, 15
;	move MOSS_WALL,		MIST_EFFECT,				 0, GRASS,		100, 15
	move SPARK,			PARALYZE_SIDE_EFFECT2,		65, ELECTRIC,	100, 20
;	move MAGNETIZE,		EVASION_DOWN2_EFFECT,		 0, ELECTRIC,	 90, 15
...
;	move DUAL_CHOP,		ATTACK_TWICE_EFFECT,		 40, DRAGON,	 90, 15
	...
	move DUST_CLOUD,	ACCURACY_DOWN_SIDE_EFFECT,	 30, GROUND,	 90, 30
;	move SAND_WAVE,		ACCURACY_DOWN_SIDE_EFFECT,	 55, GROUND,	 95, 20
...
;	move RAGING_FURY,   THRASH_PETAL_DANCE_EFFECT,  120, FIRE,    	100, 20
