...
MartGuy1Text:
	script_mart TM_MEGA_PUNCH, TM_SWORDS_DANCE, TM_RAZOR_WIND, TM_MEGA_KICK, TM_TOXIC, TM_BODY_SLAM, TM_DOUBLE_EDGE, TM_POLLINATE, TM_BUBBLEBEAM, TM_ICE_BEAM, TM_BLIZZARD, TM_HYPER_BEAM, TM_PAY_DAY, TM_COUNTER

MartGuy2Text:
	script_mart TM_SEISMIC_TOSS, TM_DRAGONBREATH, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_DRAGON_RAGE, TM_THUNDERBOLT, TM_THUNDER, TM_EARTHQUAKE, TM_FISSURE, TM_DIG, TM_PSYCHIC_M, TM_TELEPORT, TM_MIMIC, TM_ROCK_THROW

MartGuy3Text:
	script_mart TM_METRONOME, TM_SMART_STRIKE, TM_FIRE_BLAST, TM_SWIFT, TM_DRAININGKISS, TM_TOMBSTONER, TM_SLUDGE_BOMB, TM_BRUTAL_SWING, TM_REST, TM_THUNDER_WAVE, TM_FLAMETHROWER, TM_EXPLOSION, TM_ROCK_SLIDE

MartGuy4Text:
	script_mart TM_TRI_ATTACK, TM_SUBSTITUTE, PROTECTOR, UP_GRADE, DUBIOUS_DISC, METAL_COAT, BLK_AUGURITE, DOME_FOSSIL, HELIX_FOSSIL, WING_FOSSIL, OLD_AMBER
